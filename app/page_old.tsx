...
<section className="relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900 text-white overflow-hidden">
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
    ...
    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-8">
      <a href="/signup" className="w-full sm:w-auto bg-white hover:bg-gray-50 text-indigo-700 font-semibold text-lg px-12 py-4 rounded-lg shadow-lg transition-colors">
        Démarrer l'essai gratuit
      </a>
      <a href="/login" className="w-full sm:w-auto border-2 border-white hover:bg-white hover:bg-opacity-10 text-white font-medium text-lg px-12 py-4 rounded-lg transition-all">
        Se connecter
      </a>
    </div>
...
{/* Sticky CTA mobile */}
<div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3 shadow-xl md:hidden z-50">
  <a href="/signup" className="block text-center bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-base py-3 rounded-lg transition-colors">
